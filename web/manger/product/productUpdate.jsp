...
<div class="easyui-panel" title="New Topic" style="width:100%;max-width:400px;padding:30px 60px;">
    <form id="ff" method="post" action="/productUpdate.action">

        <div style="margin-bottom:20px">
            <input name="id" type="hidden" value="${product.id}" data-options="required:true">
            <input class="easyui-textbox" name="name" value="${product.name}" style="width:100%" data-options="label:'名称:',required:true">
        </div>
        <div style="margin-bottom:20px">
            <input class="easyui-textbox" name="money" value="${product.money}" style="width:100%" data-options="label:'价格:',required:true">
        </div>
        <div style="margin-bottom:20px">
            <input class="easyui-textbox" name="number" value="${product.number}" style="width:100%" data-options="label:'产品号:',required:true">
        </div>
        <div style="margin-bottom:20px">
            <input class="easyui-textbox" name="description" value="${product.description}" style="width:100%;height:60px" data-options="label:'描述:',multiline:true">
        </div>
        <%--<div style="margin-bottom:20px">--%>
        ...
        <div style="margin-bottom:20px">
            <input id="cc1" class="easyui-combobox" name="accommodationSet.id" style="width:100%;" data-options="
					url:'/updateProductAccommodation.action?id=${product.id}',
					method:'get',
					valueField:'id',
					textField:'text',
					multiple:true,
        ...
        <div style="margin-bottom:20px">
            <input class="easyui-combobox" name="foodSet.id" style="width:100%;" data-options="
					url:'/updateProductFood.action?id=${product.id}',
					method:'get',
					valueField:'id',
					textField:'text',
					multiple:true,
        ...
        <div style="margin-bottom:20px">
            <input class="easyui-combobox" name="spotSet.id" style="width:100%;" data-options="
					url:'/updateProductSpot.action?id=${product.id}',
					method:'get',
					valueField:'id',
					textField:'text',
					multiple:true,
