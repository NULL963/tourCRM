...
<div class="easyui-panel" title="New Topic" style="width:100%;max-width:400px;padding:30px 60px;">
    <form id="ff" method="post" action="/userUpdate.action">

        <div style="margin-bottom:20px">
            <input name="id" type="hidden" value="${vuser.id}" data-options="required:true">
            <input class="easyui-textbox" name="name" value="${vuser.name}" style="width:100%" data-options="label:'昵称:',required:true">
        </div>
        <div style="margin-bottom:20px">
            <input class="easyui-textbox" name="password" style="width:100%" data-options="label:'密码:',required:true">
        </div>
        <div style="margin-bottom:20px">
            <input class="easyui-textbox" name="description" value="${vuser.description}" style="width:100%;height:60px" data-options="label:'描述:',multiline:true">
        </div>
        <div style="margin-bottom:20px">
            <select class="easyui-combobox" name="employee" label="关联员工" style="width:100%">
