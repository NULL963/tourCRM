...
<div class="easyui-panel" title="New Topic" style="width:100%;max-width:400px;padding:30px 60px;">
    <form id="ff" method="post" action="/departmentUpdate.action">

        <div style="margin-bottom:20px">
            <input name="id" type="hidden" value="${department.id}" data-options="required:true">
            <input class="easyui-textbox" name="name" value="${department.name}" style="width:100%" data-options="label:'昵称:',required:true">
        </div>
    </form>
