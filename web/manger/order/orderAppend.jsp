...
<body>
<div class="easyui-panel" title="新增订单" style="width:100%;max-width:400px;padding:30px 60px;">
    <form id="ff" method="post" action="/orderAppend.action">
        <div style="margin-bottom:20px">
            <input class="easyui-textbox" name="number" style="width:100%" data-options="label:'订单号:',required:true">
        </div>
        <div style="margin-bottom:20px">
            <input class="easyui-textbox" name="money" style="width:100%" data-options="label:'价格:',required:true">
        </div>
        <div style="margin-bottom:20px">
            <input class="easyui-textbox" name="customer_number" style="width:100%;height:60px" data-options="label:'对应客户数:'">
        </div>
        <div style="margin-bottom:20px">
        ...
        <div style="margin-bottom:20px">
            <input class="easyui-datebox" name="go_off_time" style="width:100%" data-options="label:'开始日期:',required:true">
        </div>
        <div style="margin-bottom:20px">
            <input class="easyui-datebox" name="end_time" style="width:100%" data-options="label:'结束日期:',required:true">
        </div>
