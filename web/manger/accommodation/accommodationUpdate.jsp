...
<div class="easyui-panel" title="New Topic" style="width:100%;max-width:400px;padding:30px 60px;">
    <form id="ff" method="post" action="/accommodationUpdate.action">

        <div style="margin-bottom:20px">
            <input name="id" type="hidden" value="${accommodation.id}" data-options="required:true">
        ...
        <div style="margin-bottom:20px">
            <input class="easyui-textbox" name="price" value="${accommodation.price}" style="width:100%" data-options="label:'价格:' ">
        </div>
        <div style="margin-bottom:20px">
            <input class="easyui-textbox" name="address" value="${accommodation.address}" style="width:100%" data-options="label:'地址:' ">
        </div>
        <div style="margin-bottom:20px">
