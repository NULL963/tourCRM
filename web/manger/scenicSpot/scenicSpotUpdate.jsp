...
<div class="easyui-panel" title="New Topic" style="width:100%;max-width:400px;padding:30px 60px;">
    <form id="ff" method="post" action="/scenic_spotUpdate.action">

        <div style="margin-bottom:20px">
            <input name="id" type="hidden" value="${spot.id}" data-options="required:true">
            <input class="easyui-textbox" name="name" value="${spot.name}" style="width:100%" data-options="label:'名称:',required:true">
        </div>
        <div style="margin-bottom:20px">
        ...
        <div style="margin-bottom:20px">
            <input class="easyui-textbox" name="price" value="${spot.price}" style="width:100%" data-options="label:'价格:' ">
        </div>
        <div style="margin-bottom:20px">
            <input class="easyui-textbox" name="address" value="${spot.address}" style="width:100%" data-options="label:'地址:' ">
        </div>
        <div style="margin-bottom:20px">
