...
<div class="easyui-panel" title="New Topic" style="width:100%;max-width:400px;padding:30px 60px;">
    <form id="ff" method="post" action="/supplierUpdate.action">

        <div style="margin-bottom:20px">
            <input name="id" type="hidden" value="${supplier.id}" data-options="required:true">
            <input class="easyui-textbox" name="name" value="${supplier.name}" style="width:100%" data-options="label:'名称:',required:true">
        </div>
        <div style="margin-bottom:20px">
        ...
        <div style="margin-bottom:20px">
            <input class="easyui-textbox" name="address" value="${supplier.address}" style="width:100%" data-options="label:'地址:' ">
        </div>
        <div style="margin-bottom:20px">
            <input class="easyui-textbox" name="email" value="${supplier.email}" style="width:100%" data-options="label:'电子邮箱:' ">
        </div>
        <div style="margin-bottom:20px">
            <input class="easyui-textbox" name="phone" value="${supplier.phone}" style="width:100%" data-options="label:'手机号:' ">
        </div>
        <div style="margin-bottom:20px">
            <input class="easyui-textbox" name="bank_card_number" value="${supplier.bank_card_number}" style="width:100%" data-options="label:'银行卡号:' ">
        </div>
        <div style="margin-bottom:20px">
            <input class="easyui-textbox" name="bank_of_deposit" value="${supplier.bank_of_deposit}" style="width:100%" data-options="label:'具体银行:' ">
        </div>
    </form>
